...
public class DrawerActivity extends AppCompatActivity implements
    ...
    private EditText nombreUsuario,password,telefono;
    ...
    private Button enviarCorreo,configPreferencias,guardarPreferencias;
    private int id;
    ...
    private void mostrarCuadroPreferencias() {

        final android.app.AlertDialog.Builder builder=new android.app.AlertDialog.Builder(DrawerActivity.this);
        View v= getLayoutInflater().inflate(R.layout.activity_preferencias_usuario,null);

        nombreUsuario=v.findViewById(R.id.edNombreUsuario);
        password=v.findViewById(R.id.edPassword);
        telefono=v.findViewById(R.id.edtTelefono);
        configPreferencias=v.findViewById(R.id.configurarPreferencias);
        guardarPreferencias=v.findViewById(R.id.guardarPreferencias);

        nombreUsuario.setText("Usuario: "+preferences.getString("correo",""));
        password.setText("Contraseña: "+preferences.getString("contraseña",""));
        telefono.setText("Teléfono: "+preferences.getString("telefono",""));


        configPreferencias.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent i=new Intent(DrawerActivity.this,PreferenciasActivity.class);
                startActivity(i);
        ...
        guardarPreferencias.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                actualizarCredeciales(nombreUsuario,password,telefono);
            }
        });
    ...
    private void actualizarCredeciales(EditText nombreUsuario,EditText pass,EditText tlf) {
        ...
        if(!email.equals(nuevoEmail)){
            ...
            nombreUsuario.setText("Usuario: "+nuevoEmail);
        ...
        if(!password.equals(nuevaPassword)){
            ...
            pass.setText("Contraseña: "+nuevaPassword);

            Toast.makeText(this,"Se han actualizado las credenciales",Toast.LENGTH_SHORT).show();
        }
        ...
        if(!telefono.equals(nuevoTelefono)){
            ...
            tlf.setText("Teléfono: "+nuevoTelefono);
