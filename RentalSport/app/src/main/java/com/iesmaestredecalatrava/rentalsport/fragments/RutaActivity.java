...
public class RutaActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       Toast.makeText(getApplication()," "+nombrePista,Toast.LENGTH_SHORT).show();

        Toast.makeText(getApplication(),"Pulsa sobre el icono para calcular la ruta",Toast.LENGTH_SHORT).show();
    }
    ...
    private void getMyLocation() {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                Toast.makeText(getApplication(),"Lat: "+latitud+", Long: "+longitud,Toast.LENGTH_SHORT).show();
    ...
    public void onRoutingSuccess(ArrayList<Route> route, int shortestRouteIndex) {
        ...
        switch (nombrePista){
            ...
            case "Pista de Basket":
                ...
                endMarker.icon(  BitmapDescriptorFactory.fromResource(R.drawable.ic_place));
                mMap.addMarker(endMarker);
